...
export default function SidebarRoutes() {
  return (
    <div>
      <SingleItem href="/" label="Inicio" icon={House}/>
      ...
      <SingleItem href="/generator" label="Generador" icon={RectangleEllipsis} />
      ...
      <SingleItem href="/analytic" label="Analíticas" icon={BarChart}/>
